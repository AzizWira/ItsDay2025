...
function callbackFunc() {
  var items = document.querySelectorAll(".your-selector");
    ...
    <div class="card-product-favorite"  onclick="window.location.href = '${data.direct}';">
      ...
      <div class="desc-favorite">
        ...
        <div class="rate">
          ...
          <p id="product-rating-${data.id}">${data.rate}</p>
        </div>
      </div>
    </div>
`
  ...
  function searchProducts(searchValue) {
    for (const status in groupedProducts) {
      if (productContainers[status]) {
        ...
        const productElements = generateProductElements(filteredProducts);
  ...
  filterRatingSelect.addEventListener("change", function () {
    ...
    for (const status in groupedProducts) {
      if (productContainers[status]) {
        ...
        setTimeout(() => {
          // Replace content and remove fade-out class
        ...
        setTimeout(() => {
          // Remove fade-in class after fade-in animation is complete
